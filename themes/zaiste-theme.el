;;; ~/.doom.d/themes/zaiste-theme.el -*- lexical-binding: t; -*-
(require 'doom-themes)
...
(after! org
  (setq
   ...
   '(("TODO" :foreground "#7c7c75" :weight normal :underline t)
     ...
     ("IN PROGRESS" :foreground "#0098dd" :weight normal :underline t)
     ("DONE" :foreground "#50a14f" :weight normal :underline t)
     ("WON'T DO" :foreground "#ff6480" :weight normal :underline t))
   org-priority-faces '((65 :foreground "#e45649")
                        (66 :foreground "#da8548")
                        (67 :foreground "#0098dd"))
   ))
